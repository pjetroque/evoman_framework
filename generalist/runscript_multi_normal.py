...
class evo_algorithm:
    ...
    def __init__(self, n_hidden_neurons, enemy, run_nr, generations, population_size, mutation_baseline, mutation_multiplier, repeats, fitter, run, survival_number, cores='max', current_generation = 0):
        ...
        self.n_sigmas = 4
        self.cores = cores
        self.survival_number = survival_number
...
def run_experiment(n_hidden_neurons, enemies, run_nr, generations, population_size, mutation_baseline, mutation_multiplier, repeats, fitter, survival_number, cores, new):
    ...
    for run in range(run_nr):
        evo = evo_algorithm(n_hidden_neurons, enemies, run_nr, generations, population_size, mutation_baseline, mutation_multiplier, repeats, fitter, run, survival_number, cores)
...
if __name__ == '__main__':
    ...
    run_experiment(n_hidden_neurons, enemies, run_nr, generations, population_size, mutation_baseline,
                   mutation_multiplier, repeats, fitter, survival_number, cores, new)
